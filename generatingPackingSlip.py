...
def generatingPackaingSlip(RootFolder,POSource,OrderDate,ClientCode,Formulasheet,TemplateFiles):
    try:
        ...
        sourcePivot = RootFolder+"/"+ClientCode+"-"+year+"/"+OrderDate+"/60-Requirement-Summary/Requirement-Summary.xlsx"
